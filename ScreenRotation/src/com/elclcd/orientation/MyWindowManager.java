...
public class MyWindowManager {
    ...
    public static void visibleSmallWindow() {
        if (smallWindow != null) {
    ...
    public static void invisibleSmallWindow() {
        if (smallWindow != null) {
            smallWindow.setVisibility(View.GONE);
        }
    }
    
    public static int getSmallWindowVisible(){
        if(smallWindow != null)
            return smallWindow.getVisibility();
        return -1;
    }
    ...
    public static void visibleBigWindow() {
        if (bigWindow != null) {
    ...
    public static void invisibleBigWindow() {
        if (bigWindow != null) {
            bigWindow.setVisibility(View.GONE);
        }
    }
    
    public static int getBigWindowVisible(){
        if(bigWindow != null)
    ...
    public static boolean isExistSmallWindow(){
        return smallWindow != null;
    }
    
    public static boolean isExistBigWindow(){
